        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6">
                        <asp:Image ID="prodImage" runat="server" /></div>
                    <div class="col-md-6">
                        <div class="small mb-1"><a href="#">
                            <asp:Label ID="category" runat="server"></asp:Label></div>
                        <h1 class="display-5 fw-bolder">
                            <asp:Label ID="productName" runat="server" ></asp:Label>
                        </h1>
                        <h1>
                            <asp:Label ID="prodBrand" runat="server"></asp:Label></h1>
                        <div class="fs-5 mb-5">
                            ...
                            <p class="lead">
                                <asp:Label ID="description" runat="server"></asp:Label></p>
                        <div class="d-flex">
                            <input class="form-control text-center me-3" id="inputQuantity" type="num" value="1" style="max-width: 3rem" />
                            <button class="btn btn-outline-orange flex-shrink-0" type="button">
